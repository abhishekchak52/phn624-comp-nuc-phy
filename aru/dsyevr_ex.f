...
*  The information and material ("Material") provided below is owned by
*  Intel
...
*  Material
*  is protected by worldwide copyright laws and treaty provisions. No
*  part of
...
*  license
*  under such intellectual property rights must be express and approved
*  by Intel
*  in writing.
*  =============================================================================
*
...
*  eigenvectors of
*  an n-by-n real symmetric matrix A. The eigenvector v(j) of A
*  satisfies
*
*  A*v(j) = lambda(j)*v(j)
*
