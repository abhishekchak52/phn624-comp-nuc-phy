c     nilsson model
      ...
      dimension spe(km,1000)
      dimension e_levels(km)
      ...
      rmass=80.d0
      icol=0
      do n=0,80,2  !all quantum numbers multiplied by 2
        do iom=1,n+1,2
          nbas=0
          do l=n,0,-4
            do lam=-l,l,2
     ...
     &            *(1.d0-(4.d0/3.d0)*delta))**(-1.d0/6.d0)
            ...
            hw0=hw00*fdel !for results in MeV
            hw0=1.0d0
            hw00=hw0*fdel
     ...
     &                 *cgc(l,4,l1,lam,0)*cgc(l,4,l1,0,0)
      ...
      do delta=-0.3,0.301,0.01
        idef=idef+1
        write(25,'(2x,1000f9.4)')delta,(spe(idef,j),j=1,icol)
c       82 Zr
        G = (19.2+7.4*4.0)/(84.0*84.0)
        Epc = 0.0d0
        cap_del=0.0d0
        call BCS(40, G,1.0d0, spe(idef,20), spe(idef, :), Epc, cap_del)
      end do
      close(25)
      end
